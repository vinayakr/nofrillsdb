...
<nav class="bg-white shadow-lg border-b sticky top-0 z-50">
        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="hidden md:ml-10 md:flex md:space-x-8">
                    ...
                    <a href="/about" class="{$page.url.pathname === '/contact' ? 'border-indigo-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium transition-colors">
                        About Me
                    </a>
                </div>
            </div>
    ...
    <div class="{mobileMenuOpen ? 'block' : 'hidden'} md:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <a href="/about" class="{$page.url.pathname === '/contact' ? 'bg-indigo-50 border-indigo-500 text-indigo-700' : 'border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700'} block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
                About Me
            </a>
        </div>
